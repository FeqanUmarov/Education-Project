...
from .models import CourseBoss ,CourseType, Branchs, Comment, CourseApply, Exam, ExamApply,LessonPlan, Trainer, TrainerApply, Event, EventApply, Location, CoursePhoto
