...
from .models import CourseBoss ,CourseType, Branchs, Comment, CourseApply, Exam, ExamApply,CourseService, CreateBlog, Trainer, TrainerApply, Event, EventApply, Location, CoursePhoto, CreateBlog
