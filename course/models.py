...
class CourseBoss(models.Model):
    ...
    course_type = models.ForeignKey(
        CourseType, on_delete=models.CASCADE, verbose_name=_("Kursun tipi"))
    ...
    course_location = models.URLField(
        max_length=200, verbose_name=_("Kursun məkanı"))
    website = models.URLField(
        max_length=200, null=True, blank=True, verbose_name=_("Kursun saytı"))
    twitter = models.URLField(
        max_length=200, null=True, blank=True, verbose_name=_("Twitter"))
    instagram = models.URLField(
        max_length=200, null=True, blank=True, verbose_name=_("Instagram"))
    facebook = models.URLField(max_length=200, verbose_name=_("Facebook"))
    course_logo = models.ImageField(
        null=True, blank=True, verbose_name=_("Kurs logosu"))
    course_profile = models.ImageField(
        null=True, blank=True, verbose_name=_("Kurs profil şəkili"))
...
class Trainer(models.Model):
    ...
    study_field = models.CharField(
        max_length=100, verbose_name=_("Tədris sahəsi"))
    experience = models.CharField(max_length=50, verbose_name=_("Təcrübə"))
    facebook = models.URLField(max_length=200, verbose_name=_("Facebook"))
    instagram = models.URLField(
        max_length=200, null=True, blank=True, verbose_name=_("İnstagram"))
    linkedin = models.URLField(
        max_length=200, null=True, blank=True, verbose_name=_("Linkedin"))
    study_plan = RichTextField()
    note = RichTextField()
    location = models.ForeignKey(
        Location, on_delete=models.CASCADE, verbose_name=_("Ünvan"))
...
class Comment(models.Model):
    course = models.ForeignKey(
        CourseBoss, on_delete=models.CASCADE, verbose_name="Kurs", related_name="comments")
...
class Exam(models.Model):
    ...
    exam_title = models.CharField(
        max_length=30, verbose_name=_("Imtahanın adı"))
    exam_content = models.CharField(
        max_length=50, verbose_name=_("İmtahan haqqında"))
    exam_date = models.DateField(verbose_name=_("imtahan tarixi"))
    branch = models.ForeignKey(
        Branchs, on_delete=models.CASCADE, verbose_name=_("Filial"))
...
class CourseApply(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE)
    course = models.ForeignKey(CourseBoss,  on_delete=models.CASCADE)
    apply_title = models.CharField(
        max_length=30, verbose_name=_("Müraciət başlığı"))
    apply_content = models.CharField(
        max_length=100, verbose_name=_("Müraciət mövzusu"))
...
class TrainerApply(models.Model):
    ...
    apply_title = models.CharField(
        max_length=30, verbose_name=_("Müraciət başlığı"))
    apply_content = models.CharField(
        max_length=255, verbose_name=_("Müraciət mövzusu"))
    apply_date = models.DateTimeField(auto_now_add=True)
...
class EventApply(models.Model):
    ...
    apply_case = models.CharField(
        max_length=200, verbose_name=_("Müraciət səbəbi"))
...
class CreateBlog(models.Model):
    ...
    blog_title = models.CharField(
        max_length=200, verbose_name=_("Məqalə başlığı"))
    ...
    dislikes = models.ManyToManyField(User, related_name="disliked_blogs", null=True, blank=True)
