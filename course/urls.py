...
urlpatterns = [
    ...
    path('trainernotification/<int:id>', views.trainernotification, name = "trainernotification"),
    path('trainerapplynotification/<int:id>', views.trainerapplynotification, name = "trainerapplynotification"),
